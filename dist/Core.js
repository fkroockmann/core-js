...
(function () {
    ...
    require.config({
        paths: {
            'Core/Api': 'Core',
            'Core/ApplicationContainer': 'Core',
            'Core/ApplicationManager': 'Core',
            'Core/Config': 'Core',
            'Core/ControllerManager': 'Core',
            'Core/DriverHandler': 'Core',
            'Core/Exception': 'Core',
            'Core/Mediator': 'Core',
            'Core/Renderer': 'Core',
            'Core/Request': 'Core',
            'Core/RequestHandler': 'Core',
            'Core/Response': 'Core',
            'Core/RestDriver': 'Core',
            'Core/RouteManager': 'Core',
            'Core/Scope': 'Core',
            'Core/Utils': 'Core'
        }
    });
